// lib/widgets/training/step_card.dart
...
class StepCard extends StatelessWidget {
  ...
  /// (เลือกใส่) ปุ่มลัดไปเมนูคลิกเกอร์/นกหวีด
  /// ถ้าไม่ส่ง จะซ่อนปุ่ม (หรือทำปุ่มเป็น disable)
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // ===== ปุ่มลัดไปเครื่องมือ (โชว์เฉพาะเมื่อมีคีย์เวิร์ด) =====
